...
pub(crate) mod tests {
	...
	fn disconnected_blocks_do_not_become_leaves_and_warp_sync_scenario() {
		// Simulate the real warp sync flow end-to-end:
		//
		...
		// 3. Import block #20 as Final — the warp sync target block. Its parent
		...
		// Helper: import a block with a given NewBlockState, bypassing state operations.
		// Works for blocks whose parent is not in the DB.
